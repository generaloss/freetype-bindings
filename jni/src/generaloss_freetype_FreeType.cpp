...
JNIEXPORT jint JNICALL Java_generaloss_freetype_FreeType_getLastErrorCode (JNIEnv *, jclass) {
    return lastError;
}

JNIEXPORT jlong JNICALL Java_generaloss_freetype_FreeType_initFreeType (JNIEnv *, jclass) {
    FT_Library library;
...
JNIEXPORT jlong JNICALL Java_generaloss_freetype_FreeType_strokerNew (JNIEnv *, jclass, jlong libraryPtr) {
    if(!libraryPtr)
        return 0;
...
JNIEXPORT void JNICALL Java_generaloss_freetype_FreeType_doneFreeType (JNIEnv *, jclass, jlong libraryPtr) {
    if(!libraryPtr)
        return;
